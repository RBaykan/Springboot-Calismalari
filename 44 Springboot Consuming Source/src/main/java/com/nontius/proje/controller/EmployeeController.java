...
import com.nontius.proje.entityDTO.NameSurname;
...
public class EmployeeController {
	...
	public List<NameSurname> getNameSurname() {
		List<NameSurname> nameSurname = new ArrayList<NameSurname>();
		
		List<EmployeeDTO> dto = employeeService.getAllEmployees();
		
		for(EmployeeDTO d : dto) {
			
			NameSurname n = new NameSurname();
			n.setName(d.getFirstname());
			n.setSurname(d.getLastname());
			nameSurname.add(n);
		}
